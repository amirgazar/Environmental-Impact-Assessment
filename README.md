...
<li><a href="Code_Execution_and_Reproduction_Instructions.pdf">manual</a>: code reproduction information, manual for using the <code>bnlearn^[1]</code> package on our dataset.</li>
