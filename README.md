...
INSERT timestamped DOI here with link to preprint.
...
<li><a href="Reproduction Information.pdf">manual</a>: code reproduction information, manual for using the <code>bnlearn</code>
