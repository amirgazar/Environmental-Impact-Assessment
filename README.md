...
<p dir="auto">You can download and install <code>R</code> via <code>CRAN</code> for free from this <a href="https://cran.r-project.org/bin/macosx/" target="_blank">link</a></p>
...
Please cite using the following bib when using this code or the associated manuscript:
@article{Mortazavigazar2023,
    abstract = {TBD},
    archivePrefix = {TBD},
    arxivId = {TBD},
    author = {Amir Mortazavigazar, Mark Borsuk, Ryan Calder},
    eprint = {TBD},
    month = {TBD},
    title = {{Transborder electrical interties do not stimulate development of Canadian hydroelectric resources}},
    url = {TBD},
    year = {2023}
}
