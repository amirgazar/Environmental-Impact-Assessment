...
<li><a href="docs/Reproduction Information.pdf">manual</a>: code reproduction information, manual for using the <code>bnlearn</code>
 package on our dataset.</li>
<li><a href="data">dataset</a>: real dataset to use in the <code>R</code> session.</li>
<li><a href="figs">Figures</a>: Figures used in the manuscript and generated by the code in the <code>.svg</code> format</li>
</ul>
