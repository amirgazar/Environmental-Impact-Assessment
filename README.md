...
<li><a href="Hydro_EIA/Code_Execution_and_Reproduction_Instructions.pdf">docs</a>: package documentation, and usage of the <code>bnlearn</code> package on our dataset.</li>
<li><a href="blob/main/Hydro_EIA/data">dataset</a>: real dataset to use in the <code>R</code> session.</li>
</ul>
